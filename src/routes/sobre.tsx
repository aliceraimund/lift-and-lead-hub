...
import { Target, Eye, Gem, Handshake, Zap, ShieldCheck, RefreshCw, Truck, BadgeDollarSign, CheckCircle2, MessageCircle } from "lucide-react";
...
export const Route = createFileRoute("/sobre")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça a história da DJ Rent — mais de 10 anos em aluguel e venda de empilhadeiras na grande São Paulo." },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-4xl px-4 py-20 md:px-8 md:py-24">
        ...
        <h2 className="mt-3 text-3xl md:text-4xl">Da garagem do ABC ao maior parceiro logístico da região</h2>
        <div className="mt-6 space-y-5 leading-relaxed text-[var(--brand-graphite)]">
          ...
          <p>Com o crescimento da demanda, expandimos nossa frota para incluir também empilhadeiras elétricas, atendendo diversos segmentos de mercado e ambientes operacionais.</p>
          <p>Nossa trajetória é marcada pelo compromisso com qualidade, confiabilidade e inovação. Cada cliente é importante, e cada máquina é selecionada e mantida com rigor — garantindo segurança e eficiência nas operações.</p>
          <p className="font-semibold text-foreground">A DJ Rent não é apenas uma empresa de aluguel e venda. Somos parceiros dos seus projetos, crescendo junto com você.</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <MVVCard icon={Eye} title="Visão">
              Ser a referência em aluguel e venda de equipamentos de movimentação na região metropolitana de São Paulo, conhecida pela excelência, confiança e inovação.
            </MVVCard>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-24">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          {[
            { icon: Truck, title: "Frota Moderna e Diversificada", d: "Elétricas e à combustão para qualquer necessidade." },
            { icon: BadgeDollarSign, title: "Preços Competitivos", d: "Os melhores da região, com negociação flexível." },
            { icon: ShieldCheck, title: "Equipamentos Testados", d: "Cada máquina é inspecionada antes da entrega." },
            { icon: Handshake, title: "Relacionamento de Confiança", d: "Somos parceiros dos seus projetos." },
            { icon: RefreshCw, title: "Flexibilidade Contratual", d: "Dia, semana, mês ou customizado." },
            { icon: CheckCircle2, title: "Atendimento Especializado", d: "Equipe técnica pronta para recomendar a melhor solução." },
          ].map((d) => (
